...
export default function Toast() {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 rounded-2xl border border-slate-800 bg-slate-950/95 px-4 py-3.5 text-sm font-bold text-slate-50 shadow-lg backdrop-blur-md">
